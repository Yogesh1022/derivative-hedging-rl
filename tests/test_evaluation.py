...
from src.baselines.hedging_strategies import DeltaGammaHedging, DeltaHedging
...
class TestHedgingEvaluator:
    ...
    def test_initialization(self):
        ...
        evaluator = HedgingEvaluator(S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, n_steps=252)
    ...
    def test_price_path_reproducibility(self):
        ...
        evaluator = HedgingEvaluator(S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, n_steps=100)
    ...
    def test_evaluate_strategy(self):
        ...
        evaluator = HedgingEvaluator(S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, n_steps=50)

        strategy = DeltaHedging(S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call")
    ...
    def test_backtest_strategy(self):
        ...
        evaluator = HedgingEvaluator(S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, n_steps=20)
    ...
    def test_compare_strategies(self):
        ...
        comparison_df = evaluator.compare_strategies(strategies, num_episodes=5, seed=42)
...
class TestEvaluatorEdgeCases:
    ...
    def test_short_episode(self):
        ...
        evaluator = HedgingEvaluator(S0=100.0, K=100.0, T=0.1, r=0.05, sigma=0.2, n_steps=5)

        strategy = DeltaHedging(S0=100.0, K=100.0, T=0.1, r=0.05, sigma=0.2, option_type="call")
    ...
    def test_high_volatility_path(self):
        ...
        evaluator = HedgingEvaluator(S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.8, n_steps=50)
    ...
    def test_put_option_evaluation(self):
        ...
        strategy = DeltaHedging(S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="put")
