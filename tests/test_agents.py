...
class TestPPOAgent:
    ...
    def test_save_load(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Load
            loaded_agent = PPOHedgingAgent.load_pretrained(str(model_path), env=env)
    ...
    def test_get_parameters(self):
        ...
        env = OptionHedgingEnv()
        agent = PPOHedgingAgent(env=env, learning_rate=3e-4, gamma=0.99, seed=42)
...
class TestSACAgent:
    ...
    def test_train_quick(self):
        ...
        agent = SACHedgingAgent(
            env=env, seed=42, verbose=0, learning_starts=50  # Low for quick test
        )
    ...
    def test_save_load(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Load
            loaded_agent = SACHedgingAgent.load_pretrained(str(model_path), env=env)
    ...
    def test_get_parameters(self):
        """Test getting agent hyperparameters."""
        env = OptionHedgingEnv()
        agent = SACHedgingAgent(env=env, learning_rate=3e-4, gamma=0.99, tau=0.005, seed=42)
...
class TestAgentTrainer:
    ...
    def test_initialization(self):
        ...
        trainer = AgentTrainer(agent_type="PPO", output_dir="test_output", seed=42)
    ...
    def test_quick_train_ppo(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            trainer = AgentTrainer(agent_type="PPO", output_dir=tmpdir, seed=42)
    ...
    def test_quick_train_sac(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            trainer = AgentTrainer(agent_type="SAC", output_dir=tmpdir, seed=42)
...
class TestAgentEvaluator:
    ...
    def test_evaluate_baseline(self):
        ...
        # Evaluate baseline
        results = evaluator.evaluate_baseline(DeltaHedging, "Delta Hedging")
