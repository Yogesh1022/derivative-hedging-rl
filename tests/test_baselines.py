...
class TestDeltaHedging:
    ...
    def test_transaction_costs(self):
        ...
        strategy = DeltaHedging(
            S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call", transaction_cost=0.01
        )
        strategy.initialize()
...
class TestDeltaGammaHedging:
    ...
    def test_gamma_adjustment(self):
        ...
        strategy = DeltaGammaHedging(
            S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call", gamma_target=0.5
        )
        strategy.initialize()
    ...
    def test_different_gamma_weights(self):
        ...
        strategy1 = DeltaGammaHedging(
            S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call", gamma_target=0.1
        )
        strategy2 = DeltaGammaHedging(
            S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call", gamma_target=0.9
        )
...
class TestDeltaGammaVegaHedging:
    ...
    def test_vega_adjustment(self):
        ...
        strategy = DeltaGammaVegaHedging(
            S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call", vega_weight=0.5
        )
        strategy.initialize()
    ...
    def test_volatility_sensitivity(self):
        ...
        strategy = DeltaGammaVegaHedging(
            S0=100.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call", vega_weight=1.0
        )
        strategy.initialize()
...
class TestEdgeCases:
    ...
    def test_zero_time_to_maturity(self):
        ...
        strategy = DeltaHedging(S0=100.0, K=100.0, T=0.01, r=0.05, sigma=0.2, option_type="call")
        strategy.initialize()
    ...
    def test_deep_itm_hedging(self):
        ...
        strategy = DeltaHedging(S0=150.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call")
        premium = strategy.initialize()
    ...
    def test_deep_otm_hedging(self):
        ...
        strategy = DeltaHedging(S0=50.0, K=100.0, T=1.0, r=0.05, sigma=0.2, option_type="call")
        premium = strategy.initialize()
